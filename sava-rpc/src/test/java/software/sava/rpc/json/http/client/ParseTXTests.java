...
final class ParseTXTests {
  ...
  void testParseTX() {
    ...
    assertEquals(PublicKey.fromBase58Encoded("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8"), readOnly.get(2));
    ...
    assertEquals(PublicKey.fromBase58Encoded("GSUxFEYjsh9Xxa8A9k689YwG4t9NUNQvN4YinSiroXmp"), writable.get(2));
    ...
    tokenBalance = preTokenBalances.get(2);
    ...
    tokenBalance = postTokenBalances.get(2);
    assertEquals(12, tokenBalance.accountIndex());
    assertEquals(PublicKey.fromBase58Encoded("So11111111111111111111111111111111111111112"), tokenBalance.mint());
    assertEquals(PublicKey.fromBase58Encoded("5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1"), tokenBalance.owner());
    assertEquals(tokenProgram, tokenBalance.programId());
